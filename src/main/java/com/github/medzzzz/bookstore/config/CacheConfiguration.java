package com.github.medzzzz.bookstore.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("bookStore");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("bookStore");
        ...
        config.getMapConfigs().put("com.github.medzzzz.bookstore.domain.*", initializeDomainMapConfig(jHipsterProperties));
